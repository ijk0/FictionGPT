...
- 甜蜜和虐心段落交替，节奏有张有弛`,
  ...
  erotic: {
    id: 'erotic',
    label: '情色',
    description: '大胆露骨、感官描写细腻',
    promptModifier: `写作风格要求：情色小说
- 大胆直白地描写亲密场景，不回避身体细节
- 感官描写细腻入微，调动视觉、触觉、嗅觉、味觉
- 情欲场景与情感发展相结合，不做无意义的堆砌
- 通过身体语言和生理反应展现角色的欲望和情感
- 节奏上注重氛围铺垫和情绪递进
- 角色关系有深度，情欲场景服务于人物和故事发展`,
  },
  dark: {
    id: 'dark',
    label: '暗黑',
    description: '阴暗题材、道德灰色地带',
    promptModifier: `写作风格要求：暗黑风格
- 探索人性阴暗面，不回避暴力、背叛、堕落等主题
- 道德模糊，角色在灰色地带游走，没有绝对的善恶
- 氛围阴郁压抑，营造不安和紧张感
- 可以包含血腥、残酷的场景描写，但要服务于叙事
- 权力斗争、欲望、复仇等主题可以尽情展开
- 结局不必光明，允许悲剧、开放式或令人不安的收尾`,
  },
  harem: {
    id: 'harem',
    label: '后宫',
    description: '多线感情、众美环绕',
    promptModifier: `写作风格要求：后宫小说
- 主角同时与多位异性发展感情线
- 每位角色有独特的性格魅力和与主角的专属互动模式
- 角色间存在竞争、嫉妒、合作等复杂关系动态
- 暧昧和亲密场景大胆描写，不同角色有不同的情感风格
- 注重各角色的差异化：外貌、性格、相处模式各不相同
- 情感纠葛推动剧情发展，避免单纯的角色罗列`,
  },
  custom: {
    id: 'custom',
    label: '自定义',
